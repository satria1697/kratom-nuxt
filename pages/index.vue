  ...
  <div class="container">
    <div class="w-screen">
      <vue-slick-carousel v-bind="settings">
        <div v-for="i in 3" :key="i" class="w-full h-[200px] xl:h-[400px]">
          <img src="../assets/jpg/image.jpeg" class="sm:object-contain object-cover h-[800px] mx-auto w-full" alt="Image">
        </div>
      </vue-slick-carousel>
    </div>
